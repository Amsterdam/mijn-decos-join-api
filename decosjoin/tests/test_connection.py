...
class ConnectionTests(TestCase):
    ...
    def test_get_zaken(self):
        ...
        for z in zaken:
            zaken_from_fixtures.append([z['identifier'], z['status'], z['decision'], z['caseType']])

        zaken_expected = [
            ['Z/21/99012350', 'Ontvangen', 'Verleend', 'Parkeerontheffingen Blauwe zone particulieren'],
            ['Z/21/99012349', 'Ontvangen', 'Verleend', 'Parkeerontheffingen Blauwe zone bedrijven'],
